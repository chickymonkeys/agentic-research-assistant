...
Create aliases for complex types using `TypeAlias` (Python 3.10+) to improve readability:
...
Use string quotes for forward references when a class refers to itself before it's fully defined (pre-Python 3.11):
